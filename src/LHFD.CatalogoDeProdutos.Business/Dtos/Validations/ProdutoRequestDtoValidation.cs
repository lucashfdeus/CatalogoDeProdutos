...
namespace LHFD.CatalogoDeProdutos.Business.Dtos.Validations
{
    public class ProdutoRequestDtoValidation : AbstractValidator<ProdutoRequestDto>
    {
        public ProdutoRequestDtoValidation()
        {
            RuleFor(x => x.Codigo)
