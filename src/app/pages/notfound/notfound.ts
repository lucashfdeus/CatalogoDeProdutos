                    ...
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20 flex flex-col items-center" style="border-radius: 53px">
                        ...
                        <a routerLink="/" class="w-full flex items-center py-8 border-surface-300 dark:border-surface-500 border-b">
                            ...
                            <span class="ml-6 flex flex-col">
                                ...
                                <span class="text-surface-600 dark:text-surface-200 lg:text-xl">Veja se sua pergunta já foi respondida no FAQ.</span>
                            </span>
                        </a>
                        <a routerLink="/" class="w-full flex items-center py-8 border-surface-300 dark:border-surface-500 border-b">
                            <span class="flex justify-center items-center border-2 border-primary text-primary rounded-border" style="height: 3.5rem; width: 3.5rem">
                            ...
                            <span class="ml-6 flex flex-col">
                                <span class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0">Central de Soluções</span>
                                <span class="text-surface-600 dark:text-surface-200 lg:text-xl">Acesse nossa Central de Soluções.</span>
                            </span>
                        </a>
                        <a routerLink="/" class="w-full flex items-center mb-8 py-8 border-surface-300 dark:border-surface-500 border-b">
                            ...
                            <span class="ml-6 flex flex-col">
                                ...
                                <span class="text-surface-600 dark:text-surface-200 lg:text-xl">Entre em contato com Administrador</span>
                            </span>
                        </a>
                        <p-button label="Ir para Login" routerLink="/" />
                    </div>
                </div>
            </div>
        </div>`
